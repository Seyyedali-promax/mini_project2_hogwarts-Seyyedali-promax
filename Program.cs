        ...
        static void Main(string[] args)
        {
            ...
            using (StreamReader File = new StreamReader("file.tsv"))
            {
                ...
                while ((ln = File.ReadLine()) != null)
                {
                    ...
                    if (Human[8] == "teacher")
                    {
                        ...
                        TeacherIns[TeacherIndex].Letters = null;
                    ...
                    else if (Human[8] == "student")
                    {
                        ...
                        StudentIns[StudentIndex].Letters = null;
                        StudentIns[StudentIndex].PassedCourses = null;
            ...
            if (Role == 3)
            {
                ...
                else
                {
                    ...
                    //0 Incorrect 1 Himself 2 Manager 3 Plants 4 Choose lessons 5 Exit
                    if (WhichProcess == 1)
                    {
